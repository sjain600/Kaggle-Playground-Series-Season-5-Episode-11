...
## Project Goal  
### **Predicting Loan Payable**  
The primary objective of this project is to develop a classification model that a borrower will pay back their loan. The project was developed using data from the "Kaggle Playground Series" Season 5, Episode 11.
...
4. **Results**
   - The model achieved an overall OOF AUC score of <code>0.92744</code>.
